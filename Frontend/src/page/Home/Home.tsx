...
function Home() {
    ...
    isPending || isError
        ? <div className={style.postLoading} >
            { isError ? <p>Parece que ocurrio un error . . .</p> :<p>Cargando publicaciones . . .</p> }
            <img src={isError ? errorFirstLoad :postsLoadingImg} alt="Gaucho tomando mates, tranquilo esperando que suceda algo." />
            { isError && <p>Por favor, intente recargar la pagina.</p> }
        </div> 
        : <>
